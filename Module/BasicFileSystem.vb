...
Module BasicFileSystem
    ...
    Public Structure FileNameInfo
        ...
        Public AddStringName As String  '仅文件名并添加设定字符
    End Structure
    ...
    Public Function GetFileNameInfo(ByVal strFullFileName As String) As FileNameInfo
        ...
        Dim strSuffixString As String = str增加后缀
        With FNI
            ...
            .AddStringName = GetFileNameWithoutExtension2(strFullFileName) & strSuffixString
        End With
    ...
    Public Function SetNewFile(ByVal strFullFileName As String, ByVal strFilter As String) As String
        If IsFileExists(strFullFileName) = True Then
            Dim msg As DialogResult = MessageBox.Show($"已存在文件：{vbCrLf}{strFullFileName}。{vbCrLf}是——覆盖。{vbCrLf}否——另存为。", AIPTool, MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question)
            Select Case msg
