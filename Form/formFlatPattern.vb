...
, , oBaseViewOptions)
    ...
    Private Sub Btn添加展开图_Click(sender As Object, e As EventArgs) Handles btn添加展开图.Click
        ...
        If ThisApplication.ActiveDocumentType <> kDrawingDocumentObject Then
            MessageBox.Show(”请切换到工程图。“, AIPTool, MessageBoxButtons.OK, MessageBoxIcon.Error)
            Exit Sub
        End If
        ...
        If IsFileExists(strInventorPartDocumentFullFileName) = False Then
            MessageBox.Show(”未选择零件。“, AIPTool, MessageBoxButtons.OK, MessageBoxIcon.Error)
            Exit Sub
        End If
    ...
    Private Sub Btn从部件选择_Click(sender As Object, e As EventArgs) Handles btn从部件选择.Click
        If ThisApplication.ActiveDocumentType <> kAssemblyDocumentObject Then
            MessageBox.Show(”请切换到部件。“, AIPTool, MessageBoxButtons.OK, MessageBoxIcon.Error)
            Exit Sub
        End If
        ...
        If oInventorAssemblyDocument.SelectSet.Count = 0 Then
            MessageBox.Show(”在部件中选择一个零件。“, AIPTool, MessageBoxButtons.OK, MessageBoxIcon.Error)
            Exit Sub
        End If
        ...
        If oComponentOccurrence Is Nothing Then
            MessageBox.Show(”请选择一个零件。“, AIPTool, MessageBoxButtons.OK, MessageBoxIcon.Error)
            Exit Sub
        End If
    ...
    Private Sub btn选择当前零件_Click(sender As Object, e As EventArgs) Handles btn选择当前零件.Click
        ...
        If ThisApplication.ActiveDocumentType <> kPartDocumentObject Then
            MessageBox.Show(”请切换到零件。“, AIPTool, MessageBoxButtons.OK, MessageBoxIcon.Error)
            Exit Sub
        End If
