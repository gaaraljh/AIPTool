...
Public Class FormSpecification
    ...
    Private Sub FrmSpecification_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        间距ToolStripTextBox.Text = ini.GetStrFromINI("技术要求", "行距", "1", IniFile)
        ...
        If IsFileExists(strSpecificationIni) = False Then
            MessageBox.Show("未找到配置文件 Specification.ini", AIPTool， MessageBoxButtons.OK， MessageBoxIcon.Error)
            Exit Sub
        End If
    ...
    Private Sub TreeView基础数据树_NodeMouseClick(ByVal sender As Object, ByVal e As System.Windows.Forms.TreeNodeMouseClickEventArgs) Handles TreeView基础数据树.NodeMouseClick
        ...
        If boolIsBasicChange = True Then
            If MessageBox.Show($"{TreeView基础数据树.SelectedNode.Text} 已修改，是否保存？", AIPTool，
    ...
    Private Sub 删除选中项ToolStripButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles 删除选中项ToolStripButton.Click
    ...
    Private Sub 添加自定义ToolStripButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles 添加自定义ToolStripButton.Click
        Dim strChildNodeValue As String
        Me.TopMost = False
        strChildNodeValue = InputBox("输入技术要求。 ", AIPTool)
    ...
    Private Sub 插入自定义ToolStripButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles 插入自定义ToolStripButton.Click
        ...
        If lst基础数据列表.SelectedItems.Count <> 0 Then
            ...
            boolIsUserChange = True
        Else
            MessageBox.Show("请选择基础数据。", AIPTool， MessageBoxButtons.OK， MessageBoxIcon.Error)
            Exit Sub
        End If
    ...
    Private Sub TreeView自定义_NodeMouseClick(ByVal sender As Object, ByVal e As System.Windows.Forms.TreeNodeMouseClickEventArgs) Handles TreeView自定义.NodeMouseClick
        ...
        If boolIsUserChange = True Then
            If MessageBox.Show($"{TreeView自定义.SelectedNode.Text}已修改，是否保存？", AIPTool，
                               MessageBoxButtons.YesNo， MessageBoxIcon.Question) = DialogResult.Yes Then
    ...
    Private Sub 自动编号ToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)

        AutoOrderList()

    End Sub

    Private Sub 去除编号ToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    Private Sub Btn取消导入_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn取消导入.Click
        ...
        GroupBox导入自定义.Visible = False
    End Sub
    Private Sub lst基础数据列表_SelectedIndexChanged(sender As Object, e As EventArgs) Handles lst基础数据列表.DoubleClick
        ...
        AutoOrderList()
    End Sub
    Public Function AutoOrderList() As Boolean
        Dim strFlag As String
        Dim strChildNodeValue As String
        Dim intNumber As Integer
        ...
        boolIsUserChange = True
    End Function
    Public Function RemoveOrderList() As Boolean
        Dim strFlag As String
        Dim strChildNodeValue As String
        Dim intNumber As Integer
    ...
    Private Sub 去除编号ToolStripButton_ButtonClick(sender As Object, e As EventArgs) Handles 去除编号ToolStripButton1.Click
        RemoveOrderList()
    End Sub

    Private Sub lst技术要求文本_DoubleClick(sender As Object, e As EventArgs) Handles lst技术要求文本.DoubleClick
        If lst技术要求文本.SelectedItems.Count <> 0 Then
            lst技术要求文本.Items.Remove(lst技术要求文本.SelectedItems.Item(0))
            boolIsUserChange = True
        End If
    ...
    Private Sub 删除选中项ToolStripButton1_Click(sender As Object, e As EventArgs) Handles 删除选中项ToolStripButton.Click， txt导入文本.DoubleClick
        If lst技术要求文本.SelectedItems.Count <> 0 Then
            lst技术要求文本.Items.Remove(lst技术要求文本.SelectedItems.Item(0))
            boolIsUserChange = True
        End If
