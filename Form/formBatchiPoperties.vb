...
Public Class formBatchiPoperties
    ...
    Private Sub Btn确定_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn确定.Click
        ...
        Select Case tab1.SelectedIndex
            ...
            Case 0
                If cmb项目名.Text = "" Then
                    MessageBox.Show(”请选择项目。“, AIPTool, MessageBoxButtons.OK, MessageBoxIcon.Error)
            ...
            Case 1
                ...
                If txt特性名.Text = "" Then
                    MessageBox.Show(”请输入新特性的名字。“, AIPTool, MessageBoxButtons.OK, MessageBoxIcon.Error)
                    OInteractionEvents.Stop()
                    btn确定.Enabled = True
                    Exit Sub
                End If
        ...
        MessageBox.Show(”量产iProperty完成。“, AIPTool, MessageBoxButtons.OK, MessageBoxIcon.Information)
