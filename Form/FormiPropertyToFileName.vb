...
Public Class FormiPropertyToFileName
            ...
            If oBOMView.ViewType = BOMViewTypeEnum.kStructuredBOMViewType Then
                ...
                For Each oBOMRow As BOMRow In oBOMView.BOMRows
                    ...
                    Else
                        ...
                        Dim strNewFileName As String = strDrawingNnumber & str中间符号 & strPartName & oFileNameInfo.ExtensionName
    ...
    Private Sub Btn确定新文件名_Click(sender As Object, e As EventArgs) Handles btn确定新文件名.Click
        ...
        Dim strNewFileName As String = txt图号.Text & str中间符号 & txt文件名.Text & GetFileExtensionLCase(oListViewItem.SubItems(4).Text)
    ...
    Private Sub Btn开始_Click(sender As Object, e As EventArgs) Handles btn开始.Click
            ...
            If strOldFullFileName <> strNewFullFileName Then   '未更名就不进行查询组件，跳过
                ...
                For Each oComponentOccurrence As ComponentOccurrence In oComponentOccurrences
                    If oComponentOccurrence.ReferencedDocumentDescriptor.FullDocumentName = strOldFullFileName Then         '查询旧文件名的组件
                        ...
                        strOldDWGFullFileName = GetChangeExtension(strOldFullFileName, DWG)   '旧工程图
                        ...
                        If IsFileExists(strOldDWGFullFileName) = True Then
                            ...
                            strNewdwgFullFileName = GetChangeExtension(strNewFullFileName, DWG)   '新工程图
        ...
        MessageBox.Show("按iProperty更改文件名完成。", AIPTool, MessageBoxButtons.OK, MessageBoxIcon.Information)
    ...
    Private Sub Btn导出_Click(sender As Object, e As EventArgs) Handles btn导出BOM.Click
        ...
        Try
            ...
            If MessageBox.Show("数据文件导出完成，是否打开？", AIPTool, MessageBoxButtons.YesNo, MessageBoxIcon.Question) = MsgBoxResult.Yes Then
                ...
                Try
                    ...
                    Using oTextFieldParser As New TextFieldParser(openFileDialog.FileName, oEncoding)
                        ...
                        If oTextFieldParser.EndOfData Then
                            MessageBox.Show("CSV 文件为空。", AIPTool, MessageBoxButtons.OK, MessageBoxIcon.Error)
                            Return
                        End If
                        ...
                        If csvHeaders.Length <> lvw文件列表.Columns.Count Then
                            MessageBox.Show("CSV 列数不匹配。", AIPTool, MessageBoxButtons.OK, MessageBoxIcon.Error)
                            Return
                        End If

                        For i As Integer = 0 To csvHeaders.Length - 1
                            If csvHeaders(i) <> lvw文件列表.Columns(i).Text Then
                                MessageBox.Show($"列名不匹配：第 {i + 1} 列应为 [{lvw文件列表.Columns(i).Text}]", AIPTool,
                    ...
                    For Each oListViewItem As ListViewItem In lvw文件列表.Items
                        ...
                        With oListViewItem
                            ...
                            Dim strNewFileName As String = strDrawingNnumber & str中间符号 & strPartName & GetFileExtensionLCase(strOldFileName)
                    ...
                    lvw文件列表.EndUpdate()
                    MessageBox.Show("CSV 文件导入成功。", AIPTool, MessageBoxButtons.OK, MessageBoxIcon.Information)
